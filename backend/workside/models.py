...
class WorkSite(TimeStampedModel):
    ...
    monthly_rates = models.CharField(_("WorkSide Monthly Rates"), max_length=255, blank=True, null=True)
    ...
    contact_person_name = models.CharField(_("Contact Person Name"), max_length=255, blank=True, null=True)
